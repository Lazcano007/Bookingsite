...
5) After establishing the connection type in this command ```npm run dev```. It runs the application.

6) Lastly open your Insomnia/Postman and test out the different CRUD endpoints in this API.

---
## Deployment
I decided to deploy it on render. Here is the link: [Booking App Backend (Render)](https://bookingsite-cp9v.onrender.com)
